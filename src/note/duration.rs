...
impl fmt::Display for Duration {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        match *self {
            ...
            Den32(_n, _d, a) => augment(f, 'T', a),
            Den16(_n, _d, a) => augment(f, 'S', a),
            Den8(_n, _d, a) => augment(f, 'I', a),
            Den4(_n, _d, a) => augment(f, 'Q', a),
            Den2(_n, _d, a) => augment(f, 'H', a),
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        for c in iter {
            match c {
                ...
                'T' => out.push(Duration::Den32(1, 1, 0)),
                'S' => out.push(Duration::Den16(1, 1, 0)),
                'I' => out.push(Duration::Den8(1, 1, 0)),
                'Q' => out.push(Duration::Den4(1, 1, 0)),
                'H' => out.push(Duration::Den2(1, 1, 0)),
